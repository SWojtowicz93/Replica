...
function openAccordionItems() {
	...
	if(this.nextElementSibling.classList.contains('active_content')) {
		this.nextElementSibling.classList.remove('active_content')
	} else {

		closeAccordionItem()
		this.nextElementSibling.classList.toggle('active_content')
...
const closeAccordionItem = () => {
	const allActiveItems = document.querySelectorAll('.game__showed')
	allActiveItems.forEach(item => item.classList.remove('active_content'))
}
...
const clickOutsideAccordion = e => {
    if (
		...
		e.target.classList.contains('game__showed')
	)
		return
...
accordionBtns.forEach(btn => btn.addEventListener('click', openAccordionItems, {capture: true}))

// accordionBtns.addEventListener('click', clickOutsideAccordion)